...
type Province struct {
	...
	ProvinceNameTh			string			`gorm:"type:varchar(100);not null;uniqueIndex:idx_province_name_th"`
	ProvinceNameEn			string			`gorm:"type:varchar(100);not null;uniqueIndex:idx_province_name_en"`
